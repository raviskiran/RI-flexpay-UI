      ...
      <Dropdown isOpen={menu} toggle={() => setMenu(!menu)} className="d-inline-block">
        ...
        <DropdownMenu className="dropdown-menu-end">
          <DropdownItem tag="a" href="#">
            {' '}
            <i className="bx bx-user font-size-16 align-middle me-1"></i> {props.t('View Profile')}{' '}
          </DropdownItem>

          <DropdownItem tag="a" href="#">
            <i className="bx bx-wrench font-size-16 align-middle me-1"></i> {props.t('Change Password')}
          </DropdownItem>
