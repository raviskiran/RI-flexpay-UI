...
import retailInsight from '../../assets/images/companies/retailInsight.jpeg'
      ...
      <header id="page-topbar">
        <div className="navbar-header">
          <Container fluid>
            ...
            <div>
              <div className="navbar-brand-box" style={{ padding: '10px' }}>
                <span className="logo-lg">
                  <img src={retailInsight} alt="" height="45" />
                </span>
              </div>
              <button
                type="button"
