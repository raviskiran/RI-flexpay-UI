...
import UploadCards from "../pages/UploadCards/index"
import CreateCardHolder from '../pages/CreateCardHolder/index'

const userRoutes = [
  { path: "/dashboard", component: Dashboard },
  { path: '/dashboard2', component: Dashboard2 },
  { path: '/new/dashboard', component: DashboardNew },
  { path: '/new/profile-users', component: ProfileUsers },
  { path: '/new/import-cards', component: UploadCards },
  { path: '/new/generate-report', component: CreateCardHolder },
